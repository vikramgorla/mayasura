  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        ...
        <p className="text-slate-500">Everything looks good? Let&apos;s build your digital palace.</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-slate-50 rounded-xl p-4">
            ...
            <div className="flex gap-1.5 mt-2">
              <div className="h-6 w-6 rounded-full border" style={{ backgroundColor: data.primaryColor }} />
              <div className="h-6 w-6 rounded-full border" style={{ backgroundColor: data.secondaryColor }} />
              <div className="h-6 w-6 rounded-full border" style={{ backgroundColor: data.accentColor }} />
            </div>
          </div>
          ...
          <div className="bg-slate-50 rounded-xl p-4">
            ...
            <p className="text-sm mt-1">{data.fontHeading} / {data.fontBody}</p>
          </div>

          {/* Brand Voice */}
          <div className="bg-slate-50 rounded-xl p-4">
            <span className="text-xs text-slate-400 font-medium">Brand Voice</span>
            <p className="text-sm mt-1 truncate">{data.brandVoice || 'Not set'}</p>
          </div>
        </div>

        {/* Products */}
        <div className="bg-slate-50 rounded-xl p-4">
          <span className="text-xs text-slate-400 font-medium">Products ({data.products.length})</span>
        ...
        {/* Channels */}
        <div className="bg-slate-50 rounded-xl p-4">
          <span className="text-xs text-slate-400 font-medium">Active Channels ({selectedChannels.length})</span>
          <div className="flex flex-wrap gap-2 mt-2">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 text-center">
          ...
          <h3 className="font-semibold text-blue-900 mb-1">Ready to launch!</h3>
