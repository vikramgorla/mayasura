...
export default function ContentPage() {
  ...
  const typeIcons: Record<string, { icon: React.ElementType; color: string }> = {
    ...
    about: { icon: FileText, color: 'bg-zinc-50 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400' },
  };
    ...
    <div className="p-4 sm:p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-1">Generate and manage brand content with AI</p>
        </div>
      </div>
                ...
                <CardContent className="p-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed line-clamp-3 whitespace-pre-wrap">{item.body}</p>
