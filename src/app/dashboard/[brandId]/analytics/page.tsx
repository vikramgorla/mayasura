...
export default function AnalyticsPage() {
  ...
  const stats = [
    ...
    { label: 'Subscribers', value: data?.subscriberCount || 0, icon: Mail, color: 'bg-violet-50 dark:bg-violet-900/30 text-violet-600' },
  ];
    ...
    <div className="p-4 sm:p-8">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        <div className="mb-8">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-1">Track your brand&apos;s performance over the last 30 days</p>
        </div>
                  ...
                  {data.pageViews.byPage.map((page, i) => (
                    <div key={page.page} className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-zinc-700 dark:text-zinc-300 font-mono truncate max-w-[200px]">
                          {page.page}
                        </span>
                      </div>
