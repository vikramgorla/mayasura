    ...
    <div className="p-4 sm:p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-1">Manage your brand&apos;s products and services</p>
        </div>
        ...
        <Card className="mb-6 animate-scale-in">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-zinc-900 dark:text-white">New Product</h3>
      ...
      {products.length === 0 ? (
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-12 text-center">
          ...
          <h3 className="font-semibold mb-1 text-zinc-900 dark:text-white">No products yet</h3>
          <p className="text-sm text-zinc-400 dark:text-zinc-500 mb-4">Add your first product or service</p>
