    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Manage your brand&apos;s products and services</p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <Button variant="ghost" size="sm" onClick={generateDescription} disabled={!form.name || generating} className="text-blue-600 text-xs">
      ...
      {products.length === 0 ? (
        <div className="bg-white border border-slate-200 rounded-xl p-12 text-center">
          ...
          <p className="text-sm text-slate-400 mb-4">Add your first product or service</p>
