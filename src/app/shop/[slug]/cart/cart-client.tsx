    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-24 text-center">
        ...
        <Link
          ...
          style={{ backgroundColor: accentColor, color: "var(--brand-accent-text)" }}
        >
          Continue Shopping
        </Link>
      </div>
            ...
            >
              ...
              >
                {item.imageUrl ? (
                  ...
                  <Package className="h-6 w-6 opacity-20" style={{ color: "var(--brand-text)" }} />
                )}
              </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-2">
                  <div className="flex items-center border rounded" style={{ borderColor: "var(--brand-border)" }}>
                    <button
                    ...
                    <span className="w-8 text-center text-sm" style={{ color: "var(--brand-text)" }}>
                      {item.quantity}
                    </span>
                    <button
                      onClick={() => updateQuantity(item.productId, item.quantity + 1)}
              ...
              <p className="font-semibold text-sm shrink-0" style={{ color: "var(--brand-text)" }}>
            ...
            <div className="mt-4">
              <div className="flex gap-2">
                <input
                  ...
                  style={{ borderColor: "var(--brand-border)", color: "var(--brand-text)", backgroundColor: "transparent" }}
                />
                <button
